//
//  SelectSupersetExercisesTVC.swift
//  Jim
//
...
class SelectSupersetExercisesTVC: UITableViewController {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if let planSupersetTVC = segue.destinationViewController as? PlanSupersetTVC {
            planSupersetTVC.exercises = self.selectedExercises.toArray()
        }
    }
